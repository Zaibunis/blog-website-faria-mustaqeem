        ...
        <div className="container px-5 py-24 mx-auto">
          <div className="flex flex-col lg:flex-row mb-10 lg:mb-20">
            <h1 className="sm:text-3xl text-2xl font-bold title-font underline text-gray-900 mb-4 lg:mb-0 lg:w-1/3">
              ...
              <span className="block text-center lg:ml-[0]">World</span>
            </h1>
            <div className="lg:w-2/3">
              <p className="text-black font-medium leading-relaxed text-base">
                Travel opens the door to a world of endless possibilities. From
                the serene beaches of tropical islands to the vibrant energy of
                bustling cityscapes, every journey enriches your soul. Discover
                cultures, create memories, and immerse yourself in the wonders
